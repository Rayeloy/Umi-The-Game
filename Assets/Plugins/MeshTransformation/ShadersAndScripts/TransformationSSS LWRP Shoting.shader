...
Shader "Transformation/SSS ShootingLWRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#ifdef SHADER_API_D3D11
			mask177 = mask177 * _colors[v.id].x;
			...
			half4 frag (GraphVertexOutput IN ) : SV_Target
		    {
				...
				float2 uvMask_218 = lerp(lerp(lerp(lerp(uv231,uv231,_uv0Mask),uv232,_uv1Mask),uv233,_uv2Mask),uv230,_uv3Mask);
				float mask177 = ( ( clampResult175 * _Transformation ) * tex2D( _TransformationMask, uvMask_218 ).r  ) * IN.vertexColor.x;
