...
Shader "RRF_HumanShaders/Skin Shaders/SimpleSSS/SimpleSSS6"
{
	Properties
	{
		...
		_ExtraNormalMapUVbased("ExtraNormalMap(UV based)", 2D) = "bump" {}
		_FinalNormalMapPower("FinalNormalMapPower", Range( 0 , 4)) = 1
		_ExtraNormalMapPower("ExtraNormalMapPower", Range( 0 , 4)) = 1
	...
	SubShader
	{
		...
		uniform sampler2D _ExtraNormalMapUVbased;
		uniform float4 _ExtraNormalMapUVbased_ST;
		uniform float _ExtraNormalMapPower;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_ExtraNormalMapUVbased = i.uv_texcoord * _ExtraNormalMapUVbased_ST.xy + _ExtraNormalMapUVbased_ST.zw;
			float3 lerpResult251 = lerp( float3(0,0,1) , UnpackNormal( tex2D( _ExtraNormalMapUVbased, uv_ExtraNormalMapUVbased ) ) , _ExtraNormalMapPower);
			float3 lerpResult187 = lerp( float3(0,0,1) , BlendNormals( lerpResult135 , lerpResult251 ) , _FinalNormalMapPower);
...
/*ASEBEGIN
Version=17000
1927;29;1906;1014;-2125.257;304.6482;2.394483;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;134;1214.742,606.8441;Float;False;1638.046;638.4865;MicroDetails;10;142;141;140;139;138;137;136;135;249;250;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;248;2492.061,1291.567;Float;False;Property;_ExtraNormalMapPower;ExtraNormalMapPower;35;0;Create;True;0;0;False;0;1;0;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;250;2467.897,1040.466;Float;True;Property;_ExtraNormalMapUVbased;ExtraNormalMap(UV based);33;0;Create;True;0;0;False;0;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;249;2543.977,868.4955;Float;False;Constant;_Vector1;Vector 1;35;0;Create;True;0;0;False;0;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.LerpOp;251;2901.528,1033.935;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;184;3380.608,631.34;Float;False;572.3667;435.0175;FinalNormal;3;186;187;185;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector3Node;186;3416.241,688.5233;Float;False;Constant;_Vector0;Vector 0;32;0;Create;True;0;0;False;0;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.BlendNormalsNode;247;3125.82,855.1883;Float;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;185;3484.294,944.1738;Float;False;Property;_FinalNormalMapPower;FinalNormalMapPower;34;0;Create;True;0;0;False;0;1;0.37;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;187;3754.608,709.34;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=559CC7F832E0018176D7F11A7EF12C28DC4A64AE