...
Shader "RRF_HumanShaders/Skin Shaders/RnD/SimpleSkinShader_GA"
{
	Properties
	{
		_BaseSSSGlow("BaseSSSGlow", Range( 0 , 1)) = 0
		_BaseSSS_Lerp("Base-SSS_Lerp", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult130 = lerp( tex2D( _Albedo, uv_Albedo ) , tex2DNode24 , _BaseSSS_Lerp);
			...
			float4 temp_output_43_0_g6 = temp_cast_1;
			float3 normalizeResult4_g7 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float2 uv_NormalMap = i.uv_texcoord * _NormalMap_ST.xy + _NormalMap_ST.zw;
			float3 tex2DNode45 = UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap ), _NormalBumpScale );
			float3 normalizeResult64_g6 = normalize( (WorldNormalVector( i , tex2DNode45 )) );
			float dotResult19_g6 = dot( normalizeResult4_g7 , normalizeResult64_g6 );
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float3 temp_output_40_0_g6 = ( ase_lightColor.rgb * ase_lightAtten );
			float dotResult14_g6 = dot( normalizeResult64_g6 , ase_worldlightDir );
			UnityGI gi34_g6 = gi;
			float3 diffNorm34_g6 = normalizeResult64_g6;
			gi34_g6 = UnityGI_Base( data, 1, diffNorm34_g6 );
			float3 indirectDiffuse34_g6 = gi34_g6.indirect.diffuse + diffNorm34_g6 * 0.0001;
			float4 temp_output_42_0_g6 = lerpResult74;
			s105.Albedo = ( lerpResult74 + float4( ( ( (temp_output_43_0_g6).rgb * (temp_output_43_0_g6).a * pow( max( dotResult19_g6 , 0.0 ) , ( _Shininess * 128.0 ) ) * temp_output_40_0_g6 ) + ( ( ( temp_output_40_0_g6 * max( dotResult14_g6 , 0.0 ) ) + indirectDiffuse34_g6 ) * (temp_output_42_0_g6).rgb ) ) , 0.0 ) ).rgb;
			...
			s105.Emission = ( ( ( _BaseSSSGlow * lerpResult130 ) + ( ( float4( ( ( _BackScatter * ( 1.0 - clampResult104 ) ) * Scatter128 * Scatter128 * Scatter128 ) , 0.0 ) * clampResult56 ) * ase_lightColor.a ) ) * float4( temp_output_126_0 , 0.0 ) ).rgb;
...
/*ASEBEGIN
Version=16204
21;253;1272;773;-792.9396;1127.742;1.964969;True;False
...
Node;AmplifyShaderEditor.SamplerNode;7;-886.368,-1605.669;Float;True;Property;_Curvature;Curvature;18;0;Create;True;0;0;False;0;None;9622fdfc9a82dd74ab2630f3fa315307;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;61;-906.7864,-1396.689;Float;False;Property;_Curvature_Power;Curvature_Power;19;0;Create;True;0;0;False;0;1;2.19;0.1;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;123;1891.947,26.35633;Float;False;Property;_ShadowPower;ShadowPower;9;0;Create;True;0;0;False;0;0.6;0.819;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-597.0049,-976.291;Float;False;Property;_ScatterAdd;ScatterAdd;8;0;Create;True;0;0;False;0;0;0.947;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;24;-887.7233,-64.05204;Float;True;Property;_SSS_ColorWeightA;SSS_Color-Weight(A);13;0;Create;True;0;0;False;0;None;072266bafd15a4940ad8a1a2ab663193;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;38;-915.8088,-600.1253;Float;True;Property;_Albedo;Albedo;14;0;Create;True;0;0;False;0;None;c944fd4c1cdd66f4c88c89c567f64328;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;131;-600.015,-412.9756;Float;False;Property;_BaseSSS_Lerp;Base-SSS_Lerp;1;0;Create;True;0;0;False;0;0;0.042;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;126;2273.553,-221.1221;Float;False;Lerp White To;-1;;5;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;25;-891.9908,-287.8607;Float;False;Property;_SSS_BaseColorWeightA;SSS_BaseColor-Weight(A);12;0;Create;True;0;0;False;0;0.8970588,0.5474697,0.5474697,1;0.9117647,0.2413495,0.2413495,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;41;-910.8441,-778.8407;Float;False;Property;_AlbedoColor;AlbedoColor;15;0;Create;True;0;0;False;0;1,1,1,0;0.5147059,0.3496448,0.3216912,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;86;772.435,-443.9589;Float;False;674.7306;340.6641;Fuzz;3;89;31;33;;1,1,1,1;0;0
Node;AmplifyShaderEditor.LerpOp;130;-286.1941,-570.0991;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;53;96.26378,-1756.763;Float;False;Property;_BackScatter;BackScatter;7;0;Create;True;0;0;False;0;0;3.7;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;89.89128,-1645.714;Float;False;Property;_DirectScatter;DirectScatter;6;0;Create;True;0;0;False;0;0;4.31;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;814.0356,-369.9691;Float;False;Property;_Fuzz;Fuzz;10;0;Create;True;0;0;False;0;0;0.405;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;63;1502.783,-623.1344;Float;True;Property;_MetalGloss;Metal-Gloss;20;0;Create;True;0;0;False;0;None;8e3ce40f0a75d3941a9d1b1472af79ff;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;83;1896.256,-393.9281;Float;False;Property;_SmoothnessAdjust;SmoothnessAdjust;21;0;Create;True;0;0;False;0;0;0.065;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;1387.667,-1433.63;Float;False;Property;_BaseSSSGlow;BaseSSSGlow;0;0;Create;True;0;0;False;0;0;0.246;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;814.8707,-721.9401;Float;False;Property;_NormalBumpScale;NormalBumpScale;17;0;Create;True;0;0;False;0;1;0.275;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;84;2278.015,-471.472;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;89;822.6454,-285.4754;Float;False;Property;_FuzzColor;FuzzColor;11;0;Create;True;0;0;False;0;0.5147059,0.5071367,0.5071367,0;0.8235294,0.6721454,0.6721454,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;45;1133.145,-764.0339;Float;True;Property;_NormalMap;NormalMap;16;0;Create;True;0;0;False;0;None;7453b5d6856919a4aae138e8f0f6829c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;120;1920.052,-738.7758;Float;False;Blinn-Phong Light;2;;6;cf814dba44d007a4e958d2ddd5813da6;0;3;42;COLOR;0,0,0,0;False;52;FLOAT3;0,0,0;False;43;COLOR;0,0,0,0;False;2;FLOAT3;0;FLOAT;57
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3076.719,-940.1736;Float;False;True;2;Float;ASEMaterialInspector;0;0;CustomLighting;RRF_HumanShaders/Skin Shaders/RnD/SimpleSkinShader_GA;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=DD4B9A547890CDA2587A85D42B15B6FDFA98D525