...
namespace VolumetricClouds3
{
    public class VCloudShaderGUI : ShaderGUI
    {
        ...
        public static float DefaultGetPropertyHeight( MaterialProperty prop, string label, MaterialEditor editor )
        {
            switch( prop.type )
            {
                case MaterialProperty.PropType.Vector: return EditorGUIUtility.singleLineHeight * 2;
                case MaterialProperty.PropType.Texture: return EditorGUIUtility.singleLineHeight * 4;
